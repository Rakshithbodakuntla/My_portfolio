...
export default function Portfolio() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: "Designed an IoT solution to monitor humidity & soil moisture, sending real-time alerts and visualizing data with Streamlit."
    },
    {
      title: "Customer Churn Prediction",
      tech: "Python, Streamlit, Pandas, Scikit-learn",
      description: "Developed a machine learning pipeline to analyze customer data and predict churn probability using structured analytics."
    },
    {
      title: "ECG Signal Analysis and Classification Pipeline",
      tech: "Python, TensorFlow, Keras, WFDB, Scikit-learn",
      description: "Built an end-to-end DL pipeline on MIT-BIH ECG data using CNN + hybrid CNN-LSTM architectures for arrhythmia classification."
    },
  ];

  const research = [
    {
      title: "A CNN-LSTM Based Deep Learning Pipeline for ECG Signal Analysis & Arrhythmia Detection",
      description: "A hybrid deep learning approach using CNN-LSTM models to improve ECG classification accuracy."
    },
    {
      title: "Face-Recognition System Analysis using Deep Reinforcement Learning",
      description: "Developed reinforcement-learning-based strategies for large-scale face authentication systems."
    },
    {
      title: "Adversarial Machine Learning: Mitigating Attacks and Improving Robustness",
      description: "Focused on adversarial attack detection and model hardening techniques."
    }
  ];
  ...
  const card = "bg-white/95 rounded-2xl shadow-md hover:shadow-xl transition p-6";
      ...
      <div className="min-h-screen bg-[#f8fafc] text-gray-800">
              ...
              <div className="md:hidden py-4 space-y-2 bg-white border-t border-gray-200">
                {sections.map((item) => (
                  <button
                    key={item}
                    onClick={() => scrollToSection(item)}
                    className="block w-full text-left px-4 py-2 capitalize hover:bg-gray-100 rounded-lg text-gray-700"
                  >
                    {item}
                  </button>
                ))}
        ...
        <section id="home" className="pt-28 pb-16 text-center">
          <div className="max-w-6xl mx-auto">
            <div className="w-32 h-32 bg-gradient-to-br from-blue-600 to-purple-600 rounded-full flex items-center justify-center text-white text-4xl font-bold mx-auto mb-6 shadow-xl">
              RB
            </div>

            <h1 className="text-5xl md:text-6xl font-bold mb-4">
              Hi, I'm <span className="text-blue-700">Rakshith Bodakuntla</span>
            </h1>

            <p className="text-xl text-gray-600 mb-8">
              Data Engineer | Machine Learning Enthusiast | Researcher
            </p>

            <div className="flex flex-wrap justify-center gap-4">
              <a
                href="#projects"
                className="px-8 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-full font-semibold shadow hover:shadow-lg transform hover:-translate-y-1 transition-all"
              >
                View Projects
              </a>
              ...
              <a
                ...
                target="_blank"
                className="px-8 py-3 bg-white border-2 border-blue-600 text-blue-600 rounded-full font-semibold hover:bg-blue-50 flex items-center gap-2 transition"
              >
              ...
              <a
                href="#contact"
                className="px-8 py-3 bg-white border-2 border-gray-300 text-gray-700 rounded-full font-semibold hover:bg-gray-50 transition"
              >
                Contact Me
              </a>
            </div>
        ...
        {/* ============================================================
                            ABOUT SECTION
        ============================================================ */}
        <section id="about" className="py-16 bg-white px-4 border-t border-gray-200">
          <div className="max-w-6xl mx-auto text-center">
            <h2 className="text-4xl font-bold mb-6 text-blue-700 flex justify-center gap-2">
              <User /> About Me
            </h2>

            <p className="text-gray-700 leading-relaxed text-lg max-w-3xl mx-auto">
              I am a passionate Data Engineer & AI researcher pursuing my MS in Computer Science at the University of Central Missouri.
              I specialize in building scalable data pipelines, machine learning systems, and modern cloud automation.
            </p>
          </div>
        </section>
        ...
        <section id="experience" className="py-16 bg-gradient-to-br from-blue-50 to-purple-50 px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl font-bold mb-10 text-blue-700 flex items-center gap-2">
            ...
            <div className="space-y-8">
              {experience.map((exp, i) => (
                <div key={i} className={card}>
                  <h3 className="text-2xl font-bold text-blue-800">{exp.title}</h3>
        ...
        {/* ============================================================
                            SKILLS SECTION
        ============================================================ */}
        <section id="skills" className="py-16 bg-white px-4 border-t border-gray-200">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl font-bold mb-10 text-blue-700 flex items-center gap-2">
              <Code /> Skills
            </h2>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {Object.entries(skills).map(([category, items]) => (
                <div key={category} className="bg-white p-6 rounded-2xl shadow">
                  <h3 className="text-xl font-semibold text-blue-800 mb-4 capitalize">{category}</h3>
                  <ul className="space-y-2 text-gray-700">
                    {items.map((skill) => (
                      <li key={skill} className="flex items-center gap-2">
                        <div className="w-2 h-2 bg-blue-600 rounded-full" /> {skill}
                      </li>
                    ))}
                  </ul>
                </div>
        ...
        <section id="projects" className="py-16 bg-gradient-to-br from-blue-50 to-purple-50 px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {projects.map((p, i) => (
                <div key={i} className={card}>
                  <h3 className="text-2xl font-bold text-blue-900 mb-2">{p.title}</h3>
        ...
        {/* ============================================================
                            RESEARCH SECTION
        ============================================================ */}
        <section id="research" className="py-16 bg-white px-4 border-t border-gray-200">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl font-bold mb-10 text-blue-700 flex items-center gap-2">
            ...
            <div className="mt-12">
              <h3 className="text-3xl font-bold mb-6 flex items-center gap-2 text-blue-700">
                <Award size={28} /> Certifications
              </h3>

              <div className="grid md:grid-cols-2 gap-4">
                {certifications.map((c, i) => (
                  <div key={i} className="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-4 rounded-xl flex items-center gap-3 shadow">
