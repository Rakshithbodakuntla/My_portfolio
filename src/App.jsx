...
export default function Portfolio() {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 text-gray-800">
      ...
      {/* ================= HERO ================= */}
      <section id="home" className="pt-28 pb-16 text-center relative z-10">
      ...
      {/* ================= ABOUT ================= */}
      <section id="about" className="py-16 px-4 bg-white relative z-10">
      ...
      {/* ================= EXPERIENCE ================= */}
      <section id="experience" className="py-16 px-4 bg-gradient-to-br from-blue-50 to-purple-50 relative z-10">
        <div className="max-w-6xl mx-auto">
      ...
      {/* ================= SKILLS ================= */}
      <section id="skills" className="py-16 px-4 bg-white relative z-10">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-bold mb-10 flex items-center gap-2 text-blue-600">
            <Code /> Skills
          </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {Object.entries(skills).map(([category, items]) => (
              <div key={category} className="bg-gradient-to-br from-blue-50 to-purple-50 p-6 rounded-2xl shadow">
      ...
      {/* ================= PROJECTS ================= */}
      <section id="projects" className="py-16 px-4 bg-gradient-to-br from-blue-50 to-purple-50 relative z-10">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-bold mb-10 flex items-center gap-2 text-blue-600">
            <Briefcase /> Projects
          </h2>
      ...
      {/* ================= RESEARCH ================= */}
      <section id="research" className="py-16 px-4 bg-white relative z-10">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-bold mb-10 flex items-center gap-2 text-blue-600">
      ...
      {/* ================= CONTACT ================= */}
      <section id="contact" className="py-16 px-4 bg-gradient-to-br from-blue-50 to-purple-50 relative z-10">
