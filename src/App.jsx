...
export default function Portfolio() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: "Developed an ML pipeline to analyze customer data and predict churn risk through interactive dashboards for proactive retention strategies."
    },
    {
