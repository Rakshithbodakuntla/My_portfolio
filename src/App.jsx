        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              <a href="https://www.linkedin.com/in/bodakuntlarakshith1/" className="text-blue-600 hover:text-purple-600 transition">
                <Linkedin size={28} />
              </a>
              <a href="https://github.com/Rakshithbodakuntla" className="text-blue-600 hover:text-purple-600 transition">
                <Github size={28} />
              </a>
            </div>
          </div>
